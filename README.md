...
| fraho.jwt.anonymous.disable | false        | Disable anonymous access (access with ROLE_ANONYMOUS) completely. See [Spring Security Docs](https://docs.spring.io/spring-security/reference/servlet/authentication/anonymous.html) for more information.                                                                                                                                                                        |
