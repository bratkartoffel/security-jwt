...
@Slf4j
@SpringBootTest(properties = "spring.config.location=classpath:test-crypt-sha256.yaml",
        classes = TestApiApplication.class)
@RunWith(SpringJUnit4ClassRunner.class)
public class TestCryptPasswordEncoderSha256 extends AbstractCryptTest {
    @BeforeClass
