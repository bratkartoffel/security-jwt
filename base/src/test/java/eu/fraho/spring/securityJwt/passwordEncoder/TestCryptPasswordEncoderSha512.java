...
@Slf4j
@SpringBootTest(properties = "spring.config.location=classpath:test-crypt-sha512.yaml",
        classes = TestApiApplication.class)
@RunWith(SpringJUnit4ClassRunner.class)
public class TestCryptPasswordEncoderSha512 extends AbstractCryptTest {
    @BeforeClass
