...
@Slf4j
@SpringBootTest(properties = "spring.config.location=classpath:test-crypt-few-rounds.yaml",
        classes = TestApiApplication.class)
@RunWith(SpringJUnit4ClassRunner.class)
public class TestCryptPasswordEncoderFewRounds extends AbstractCryptTest {
    @BeforeClass
