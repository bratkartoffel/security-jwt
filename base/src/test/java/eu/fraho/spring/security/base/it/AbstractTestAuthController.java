...
import eu.fraho.spring.security.base.ut.service.TestTotpService;
...
abstract class AbstractTestAuthController {
    ...
    public void testLoginCorrectTotp() throws Exception {
        ...
        long totp = TestTotpService.getCodeForTesting(totpService, UserDetailsServiceTestImpl.BASE32_TOTP, 0);
        req = MockMvcRequestBuilders.post(AUTH_LOGIN)
                .contentType(MediaType.APPLICATION_JSON)
