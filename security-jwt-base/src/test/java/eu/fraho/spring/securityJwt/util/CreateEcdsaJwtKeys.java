...
public class CreateEcdsaJwtKeys {
    public static final String OUT_PUB_KEY = "out/pub.key";
    public static final String OUT_PRIV_KEY = "out/priv.key";
    public static final String OUT_PUB_JWK = "out/jwk_pub.json";
    public static final String OUT_PRIV_JWK = "out/jwk_priv.json";
